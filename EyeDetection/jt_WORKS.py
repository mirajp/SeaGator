...
def getLeftPupil(oldPupils):
    ...
    while 1:
        ...
        for (x,y,w,h) in faces:
            ...
            cv2.moveWindow("Live Feed",1000,800)
            if len(eyes) > 0:
                ...
                if circles0 is not None:
                    ...
                    for i in circles0[0,:]:
                        ...
                        xcorr = -2
                        ycorr = -2
                        cv2.circle(ceye0,(int(i[0]+xcorr),int(i[1]+ycorr)),3,(0,0,255),1) # draw the outer circle
                        cv2.circle(ceye0,(int(i[0]+xcorr),int(i[1]+ycorr)),1,(0,0,255),1) # draw the center of the circle
